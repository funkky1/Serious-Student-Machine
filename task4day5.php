...
$collection2->update(array("username"=>$user->username), 
      array('$set'=>array("task5day1"=>"1")));
$collection2->update(array("username"=>$user->username), 
      array('$set'=>array("task5"=>"1")));
...
<title>Task 4 Day 5</title>
</head>
<body>
<div id="contentarea">
<div id="innercontentarea">
<h2 style="color:green">Get Moving..(Day 5)..</h2>
<a href="task4index.php"><h3>Level-4 Index</h3></a>
<br>
<?php if ($action === 'show_form'): ?>
<form action="<?php echo $_SERVER['PHP_SELF'];?>"
method="post">
<h3 style="color:red">The amount walked ..</h3>
<h3>Title</h3>
...
<p>
<h3 style="color:red">The feelings before..</h3>
<h3>Title</h3>
<p>
...
<p>
<h3 style="color:red">The feelings after..</h3>
<h3>Title</h3>
<p>
