...
$collection2->update(array("username"=>$user->username), 
      array('$set'=>array("task4day1"=>"1")));
$collection2->update(array("username"=>$user->username), 
      array('$set'=>array("task4"=>"1")));
...
<title>Task 3 Day 5</title>
</head>
<body>
<div id="contentarea">
<div id="innercontentarea">
<h2 style="color:green">Reflections on personal experiences(Day 5)..</h2>
<a href="task3index.php"><h3>Level-3 Index</h3></a>
<br>
<?php if ($action === 'show_form'): ?>
<form action="<?php echo $_SERVER['PHP_SELF'];?>"
method="post">
<h3 style="color:red">How much time spent with your loved ones?</h3>
<h3>Title</h3>
...
<p>
<h3 style="color:red">How much time you would like to spend with loved ones?</h3>
<h3>Title</h3>
<p>
...
<p>
<h3 style="color:red">What you can do to make it happen?</h3>
<h3>Title</h3>
<p>
