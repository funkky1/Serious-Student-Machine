...
$collection2->update(array("username"=>$user->username), 
      array('$set'=>array("task2"=>"1")));
	  
$collection2->update(array("username"=>$user->username), 
      array('$set'=>array("task2day1"=>"1")));
...
<title>Task 1 Day 5</title>
</head>
<body>
<div id="contentarea">
<div id="innercontentarea">
<h2 style="color:green">Tell the Good things happened during the day (Day 5)..</h2>
<a href="task1index.php"><h3>Level-1 Index</h3></a>
<br>
<?php if ($action === 'show_form'): ?>
<form action="<?php echo $_SERVER['PHP_SELF'];?>"
method="post">
<h3 style="color:red">Good Thing 1</h3>
<h3>Title</h3>
...
<p>
<h3 style="color:red">Good Thing 2</h3>
<h3>Title</h3>
<p>
...
<p>
<h3 style="color:red">Good Thing 3</h3>
<h3>Title</h3>
<p>
