...
$articleCollection = $mongodb->testblog->articles;
...
<thead>
<tr>
<th width="55%" style="color:red">Title</th>
<th width="27%"  style="color:red">Created at</th>
<th width="*"  style="color:red">Action</th>
</tr>
</thead>
<tbody>
...
<td class="url">
<a href="post.php?id=<?php echo $article['_id']; ?>">View
</a>
| <a href="edit.php?id=<?php echo $article['_id'];?>">Edit
</a>
</td>
</tr>
<?php endwhile;?>
